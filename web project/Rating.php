...
<?php
include "configDB.php"; // Включете файл с конфигурацията на базата данни
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($user_result && mysqli_num_rows($user_result) > 0) {
        ...
        // Вмъкване на отзива в таблицата reviews
